...
RSpec.describe ExpedientesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all expedienteses as @expedienteses" do
      expediente = Expediente.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:expedientes)).to eq([expediente])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested expediente as @expediente" do
      ...
      expect(assigns(:expediente)).to eq(expediente)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new expediente as @expediente" do
      ...
      expect(assigns(:expediente)).to be_a_new(Expediente)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created expediente as @expediente" do
        post :create, {:expediente => valid_attributes}, valid_session
        expect(assigns(:expediente)).to be_a(Expediente)
        expect(assigns(:expediente)).to be_persisted
      end
